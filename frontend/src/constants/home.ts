...
export const HOME_UI = {
  ...
  featuredEyebrow: { vi: 'Sản Phẩm Tiêu Biểu', en: 'Selected Portfolio' },
  featuredTitleLine1: { vi: 'Dự Án', en: 'Featured' },
  featuredTitleLine2: { vi: 'Nổi Bật', en: 'Projects' },
  viewDetail: { vi: 'Xem Chi Tiết', en: 'View Details' },
  expertiseEyebrow: { vi: 'Năng Lực Cốt Lõi', en: 'Core Specialization' },
  expertiseTitleLine1: { vi: 'Giải Pháp &', en: 'Technical Solutions &' },
  expertiseTitleLine2: { vi: 'Chuyên Môn Hệ Thống', en: 'System Expertise' },
